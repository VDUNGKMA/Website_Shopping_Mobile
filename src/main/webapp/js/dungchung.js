	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="tintuc.jsp"><i class="fa fa-newspaper-o"></i> Tin tức</a></li>
                <li><a href="tuyendung.jsp"><i class="fa fa-handshake-o"></i> Tuyển dụng</a></li>
                <li><a href="gioithieu.jsp"><i class="fa fa-info-circle"></i> Giới thiệu</a></li>
                <li><a href="trungtambaohanh.jsp"><i class="fa fa-wrench"></i> Bảo hành</a></li>
                <li><a href="lienhe.jsp"><i class="fa fa-phone"></i> Liên hệ</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
