window.onload = function () {
	...
	for (var t of tags) addTags(t, "index.jsp?search=" + t);
...
function clearAllProducts() {
	document.getElementById('products').HTML.inner = "";
}
...
// 	s += `	</div>
// 			<a class="xemTatCa" href="index.jsp?` + filter.join('&') + `" style="` + borderA + `">
...
function createLinkFilter(type, nameFilter, valueAdd) {
	...
	var link = 'index.jsp'; //window.location.href.split('?')[0].replace('#', '');
