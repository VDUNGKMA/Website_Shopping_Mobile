...
<div class="container">
    <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach items="${ListProudct}" var="o">
                <tr>
                    <td>
                                    <span class="custom-checkbox">
                    ...
                    <td><fmt:formatNumber type="currency" value="${o.getPrice()}" currencySymbol="" />₫</td>
                    <td>
                        <a href="load-product?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="add-product" method="post" onsubmit="updateDescriptionData()">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" id="getDatabtn" class="btn btn-success" value="Add">
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    document.getElementById('getDatabtn').addEventListener('click', updateDescriptionData);
